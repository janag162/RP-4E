...
public enum ModArmorMaterials implements ArmorMaterial {
    DIREWOLF("direwolf_cloak", 20, new int[]{0, 5, 0, 0}, 15,
            SoundEvents.ARMOR_EQUIP_LEATHER, 1F, 2F, () -> Ingredient.of(ModItems.DIREWOLF_FUR.get(), ModItems.DIREWOLF_PELT.get()));
    ...
    public String getName() {
        return MutantMinecraft.MOD_ID + ":" + this.name;
    }
